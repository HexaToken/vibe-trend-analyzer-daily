...
export const CommunityForum: React.FC = () => {
  ...
  const mockPosts: Post[] = [
    {
      ...
      content: 'AI earnings season is looking incredibly strong! $NVDA absolutely crushing expectations and $MSFT showing solid cloud growth. The future is bright for tech 🚀',
      tickers: ['NVDA', 'MSFT'],
      tags: ['Tech', 'Earnings'],
      sentiment: 'bullish',
      likes: 47,
      ...
      comments: [
        {
          ...
          content: 'Agree on NVDA but worried about MSFT valuations at these levels',
          likes: 12,
    ...
    },
    {
      ...
      userAvatar: '/api/placeholder/40/40',
      content: 'Fed meeting tomorrow has me nervous. Expecting volatility across all markets. $SPY puts might be the play 📉',
      tickers: ['SPY'],
      tags: ['Fed', 'Options'],
      sentiment: 'bearish',
      likes: 23,
    ...
    },
    {
      ...
      userAvatar: '/api/placeholder/40/40',
      content: 'While everyone\'s chasing growth, I\'m quietly building my dividend portfolio. $JNJ, $PG, $KO - boring but reliable cash flow 💰',
      tickers: ['JNJ', 'PG', 'KO'],
  ...
  const handleSubmitPost = () => {
    ...
    const tickers = (newPost.match(/\$([A-Z]{1,5})/g) || []).map(ticker => ticker.substring(1));
    const hashtags = (newPost.match(/#([A-Za-z0-9_]+)/g) || []).map(tag => tag.substring(1));
  ...
  const handleDislikePost = (postId: string) => {
    setPosts(prev => prev.map(post => 
      post.id === postId 
        ? {
            ...post,
            dislikes: post.isUserDisliked ? post.dislikes - 1 : post.dislikes + 1,
  ...
  const getSentimentEmoji = (sentiment: string) => {
    switch (sentiment) {
      case 'bullish': return <Smile className="h-4 w-4 text-green-500" />;
      case 'bearish': return <Frown className="h-4 w-4 text-red-500" />;
  ...
  const filteredPosts = posts.filter(post => 
    ...
    post.tickers.some(ticker => ticker.toLowerCase().includes(searchQuery.toLowerCase())) ||
        ...
        <Card>
          <CardContent className="p-8 text-center">
            ...
            <p className="text-muted-foreground mb-4">
              Sign in to share your market insights and join discussions with other traders.
            </p>
                ...
                <div className="flex-1 space-y-4">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-4">
                      <Select value={selectedSentiment} onValueChange={(value: any) => setSelectedSentiment(value)}>
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <div className="flex items-center gap-2">
                          ...
                          <Badge className={`text-xs ${getSentimentBadgeColor(post.sentiment)}`}>
                  ...
                  <div className="flex items-center justify-between mt-4 pt-4 border-t">
                    <div className="flex items-center gap-4">
                      ...
                      <Button
                        ...
                        className={post.isUserDisliked ? 'text-red-600' : ''}
                      >
            ...
            <CardContent className="space-y-4">
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-sm font-medium">{moodPollData.bullish}%</span>
                </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-sm font-medium">{moodPollData.neutral}%</span>
                </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-sm font-medium">{moodPollData.bearish}%</span>
                </div>
