              ...
              <Card className="bg-black/40 backdrop-blur-xl border-purple-500/20 hover:border-purple-500/30 transition-all duration-300">
                <CardContent className="p-8">
                  <div className="flex items-center gap-3 mb-6">
                    ...
                    <div>
                      <h4 className="text-xl font-bold text-white">Free Plan Features</h4>
                      <p className="text-gray-400 text-sm">Essential tools to get started</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-3 mb-6">
                    ...
                    <div>
                      <div className="flex items-center gap-2">
                        <h4 className="text-xl font-bold text-white">Pro Plan Features</h4>
                        <Badge className="bg-blue-500/20 text-blue-300 border-blue-500/30">
                          Popular
                        </Badge>
                      </div>
                      <p className="text-gray-400 text-sm">Advanced AI-powered tools</p>
                    </div>
                  </div>
