        ...
        <CardContent className="p-0">
          <div ref={heatmapRef} className="overflow-x-auto">
            ...
            {heatmapData.map((ticker, tickerIndex) => (
              <div
                key={ticker.ticker}
                className="grid grid-cols-[120px_1fr] border-b border-gray-100 dark:border-gray-800 hover:bg-gray-50 dark:hover:bg-gray-900 group"
              >
                {/* Ticker Info */}
                <div className="p-3 border-r border-gray-200 dark:border-gray-700 flex items-center justify-between">
                  <div>
                    <div className="flex items-center gap-2">
