  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#0F1222] via-[#1A1F3A] to-[#0F1222] text-white overflow-hidden">
      ...
      <div className="flex flex-1 h-[calc(100vh-140px)] trading-chart-mobile">
          ...
          <div className="px-6 pt-4">
            <Tabs value={activeTab} onValueChange={setActiveTab}>
              ...
              <TabsContent value="chart" className="mt-0">
                {/* Chart Canvas */}
                <div className="relative bg-gradient-to-br from-gray-900/50 to-gray-800/30 rounded-2xl border border-gray-700/50 h-[500px] overflow-hidden">
                  {/* Grid Background */}
                  ...
                  <div className="absolute left-4 top-1/2 transform -translate-y-1/2 z-20">
                    <div className="bg-gray-800/80 backdrop-blur-sm rounded-xl border border-gray-700/50 p-2 space-y-2">
                      {[
                        ...
                        <Button
                          ...
                          variant="ghost"
                          size="sm"
                          className="w-10 h-10 p-0 hover:bg-cyan-400/20"
                        >
        ...
        {/* Right Sidebar */}
        <div className={cn(
          "w-80 bg-gray-900/50 border-l border-gray-700/50 transition-all duration-300",
