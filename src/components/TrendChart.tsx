    ...
    <Card>
      ...
      <CardContent>
        ...
        <div className="mt-4 grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
          ...
          <div className="text-center">
            <div className="font-semibold" style={{ color: "hsl(var(--chart-secondary))" }}>News</div>
            <div className="text-muted-foreground">7-day avg: 67.4</div>
          </div>
          <div className="text-center">
            <div className="font-semibold" style={{ color: "hsl(var(--chart-tertiary))" }}>Social</div>
            <div className="text-muted-foreground">7-day avg: 73.3</div>
          </div>
          <div className="text-center">
            <div className="font-semibold" style={{ color: "hsl(var(--chart-quaternary))" }}>Stocks</div>
